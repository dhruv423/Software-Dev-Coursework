...
xe = CompoundT(MolecSet([MoleculeT(1, ElementT.Xe)]))
f = CompoundT(MolecSet([MoleculeT(2, ElementT.F)]))
xef5 = CompoundT(MolecSet([MoleculeT(5, ElementT.F), MoleculeT(1, ElementT.Xe)]))

test = ReactionT([xe, f], [xef5])
